...
insert into mist_markets (id,base_token_address,base_token_symbol,quote_token_address,quote_token_symbol,online,up_at,down_at,created_at) values ('USDT-CNYC', '0x63a51e9210cb0a90dac6cb1b126e09d9a85f20a91a','USDT', '0x63405243ab1961e46dddb4fa32da3ba4cf7f8f6d7d','CNYC', true,NOW(),NOW() + '10 years',NOW());

insert into mist_markets (id,base_token_address,base_token_symbol,quote_token_address,quote_token_symbol,online,up_at,down_at,created_at) values ('BTC-CNYC', '0x63fa60d732b1aaf1e2bf033636e4084cbcc4946848','BTC', '0x63405243ab1961e46dddb4fa32da3ba4cf7f8f6d7d','CNYC', true,NOW(),NOW() + '10 years',NOW());
...
insert into mist_markets (id,base_token_address,base_token_symbol,quote_token_address,quote_token_symbol,online,up_at,down_at,created_at) values ('ASIM-USDT', '0x636612e15fcf5c4f4ed364eeaf3e616ec8932d1a4d','ASIM', '0x63a51e9210cb0a90dac6cb1b126e09d9a85f20a91a','USDT', true,NOW(),NOW() + '10 years',NOW());
insert into mist_markets (id,base_token_address,base_token_symbol,quote_token_address,quote_token_symbol,online,up_at,down_at,created_at) values ('ETH-USDT', '0x63a75cda5b6e6ce688676ead327e826e6a07d43553','ETH', '0x63a51e9210cb0a90dac6cb1b126e09d9a85f20a91a','USDT', true,NOW(),NOW() + '10 years',NOW());
insert into mist_markets (id,base_token_address,base_token_symbol,quote_token_address,quote_token_symbol,online,up_at,down_at,created_at) values ('BTC-USDT', '0x63fa60d732b1aaf1e2bf033636e4084cbcc4946848','BTC', '0x63a51e9210cb0a90dac6cb1b126e09d9a85f20a91a','USDT', true,NOW(),NOW() + '10 years',NOW());
...
insert into mist_tokens (address, symbol, name,decimals,asim_address,asim_assetid) values ('0x63fa60d732b1aaf1e2bf033636e4084cbcc4946848', 'BTC','BTCC', 8,'0x63ed080e7f11494e7563fff04668dfddc1555398de','000000000000000200000001');
insert into mist_tokens (address, symbol, name,decimals,asim_address,asim_assetid) values ('0x63a51e9210cb0a90dac6cb1b126e09d9a85f20a91a', 'USDT','USDTS', 8,'0x63ed080e7f11494e7563fff04668dfddc1555398de','000000000000000200000003');
